...
import './resetIcon.less';

export default props => (
    <div onClick={props.onClick} className='resetIconBtn'>
        <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 14.155 14.155" width={props.width} height={props.height}>
            <g>
